class FastagConfirmModel {
  bool? success;
  FastagConfirmData? data;
  String? message;
  int? code;

  FastagConfirmModel({this.success, this.data, this.message, this.code});

  FastagConfirmModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    data = json['data'] != null
        ? FastagConfirmData.fromJson(json['data'])
        : null;
...
class FastagConfirmData {
  ...
  FastagConfirmData.fromJson(Map<String, dynamic> json) {
