class BroadbandConfirmModel {
  bool? success;
  BroadbandConfirmData? data;
  String? message;
  int? code;

  BroadbandConfirmModel({this.success, this.data, this.message, this.code});

  BroadbandConfirmModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    data = json['data'] != null
        ? BroadbandConfirmData.fromJson(json['data'])
        : null;
...
class BroadbandConfirmData {
  ...
  BroadbandConfirmData.fromJson(Map<String, dynamic> json) {
    ...
    logo = json['product_logp'] ?? json['product_logo'];
  }
