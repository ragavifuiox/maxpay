class CableTvConfirmModel {
  bool? success;
  CableTvConfirmData? data;
  String? message;
  int? code;

  CableTvConfirmModel({this.success, this.data, this.message, this.code});

  CableTvConfirmModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    data = json['data'] != null
        ? CableTvConfirmData.fromJson(json['data'])
        : null;
...
class CableTvConfirmData {
  ...
  CableTvConfirmData.fromJson(Map<String, dynamic> json) {
