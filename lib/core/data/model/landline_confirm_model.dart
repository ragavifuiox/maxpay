class LandlineConfirmModel {
  bool? success;
  LandlineConfirmData? data;
  String? message;
  int? code;

  LandlineConfirmModel({this.success, this.data, this.message, this.code});

  LandlineConfirmModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    data = json['data'] != null
        ? LandlineConfirmData.fromJson(json['data'])
        : null;
...
class LandlineConfirmData {
  ...
  LandlineConfirmData.fromJson(Map<String, dynamic> json) {
