...
class ConfirmFastagPage extends StatefulWidget {
  ...
  @override
  State<ConfirmFastagPage> createState() => _ConfirmFastagPageState();
}

class _ConfirmFastagPageState extends State<ConfirmFastagPage> {
  final TextEditingController whatsappController = TextEditingController();
  final TextEditingController amountController = TextEditingController();
  late final FastagController controller;
  ...
  void initState() {
    ...
    if (pId.isNotEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        controller.fetchConfirmTransaction(pId);
      });
    }
  }
                      ...
                      Expanded(
                        child: _pillButton(
                          ...
                          onTap: () {
                            ...
                            Get.to(CustomerFastag(), arguments: args);
                          },
                        ),
                      ),
                      SizedBox(width: 12.w),
