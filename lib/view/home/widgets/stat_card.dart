    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            /// IMAGE / ICON
            /// 👇 Flexible instead of a fixed 40.h SizedBox — lets the
            /// image box shrink if the parent gives less height than that.
            Flexible(
              flex: 2,
              child: SizedBox(
                height: 40.h,
            ...
            /// 👇 Flexible so the title never forces the Column past
            /// the available height — it will shrink/clip instead of overflow.
            Flexible(
              child: Text(
                title,
                textAlign: TextAlign.center,
