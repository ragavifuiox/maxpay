...
class DisputeDialog extends StatefulWidget {
  ...
  @override
  State<DisputeDialog> createState() =>
      _DisputeDialogState();
}

class _DisputeDialogState
    extends State<DisputeDialog> {
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    print(
                      "Transaction ID: ${widget.rechargeId}",
                    );
                    print(
                  ...
                  child:
                      const Text("Cancel",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),),
                ),
