...
class LoginPhonePage extends GetView<AuthController> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Container(height: 21.h, width: 1, color: Colors.grey.shade400),
          ...
          Expanded(
            child: TextField(
              ...
              maxLength: 10,
              style: TextStyle(fontSize: isTablet ? 8.sp : 13.sp),
